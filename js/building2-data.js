...
// 빌딩 데이터를 워크시트에 입력
function fillBuildingData(worksheet, building, columnIndex) {
    ...
    // 임차 제안 기본값 설정 (25-31행)
    setDefaultProposalValues(worksheet, col);
    
    // 임대 기준 기본값 설정 (32-34행)
    setDefaultRentValues(worksheet, col);
