...
async function exportToExcel() {
    ...
    try {
        ...
        worksheet.mergeCells('B28:B31'); // (평기준 임대/전용면적 입력시 자동계산)
        worksheet.mergeCells('B32:B39'); // 임대 기준
        worksheet.mergeCells('B36:B39'); // (평기준 보/임/관 입력시 자동계산)
        worksheet.mergeCells('B40:B44'); // 임대 기준 조정
        worksheet.mergeCells('B42:B44'); // (렌트프리 개월 입력시 자동계산)
        ...
        setCategoryCell(worksheet, 'B28', '(평기준 임대/전용면적 입력시 자동계산)', 'FFF9D6AE', true);
        setCategoryCell(worksheet, 'B32', '임대 기준', 'FFD9ECF2');
        setCategoryCell(worksheet, 'B36', '(평기준 보/임/관 입력시 자동계산)', 'FFD9ECF2', true);
        setCategoryCell(worksheet, 'B40', '임대기준 조정', 'FFD9ECF2');
        setCategoryCell(worksheet, 'B42', '(렌트프리 개월 입력시 자동계산)', 'FFD9ECF2', true);
